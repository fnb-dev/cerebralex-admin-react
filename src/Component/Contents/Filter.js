...
const Filter = () => {
    ...
    return(
        <div className="filter-wrapper border-left ml-4 pl-4 d-flex align-items-center">
            <div className={filterEdittoggle ? "active-fliter-item shown" : "active-fliter-item"}>
            ...
            <div className="active-fliter-item">
                <div className="d-flex active-fliter-action">
            ...
            <Button variant="outline-white" className="filter-btn" onClick={() => setToggleFilter(!toggleFilter)}><i className="fa fa-filter" aria-hidden="true"></i> Add Filter</Button>
